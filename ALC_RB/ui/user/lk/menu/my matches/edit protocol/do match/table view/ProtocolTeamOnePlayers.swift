...
class ProtocolTeamOnePlayers : NSObject {
    enum Cell {
        static let CELL = "cell_protocol_team_one"
    }
...
extension ProtocolTeamOnePlayers : UITableViewDelegate {
...
extension ProtocolTeamOnePlayers : UITableViewDataSource {
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return dataSource.count
    }
    
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: Cell.CELL, for: indexPath) as! RefereeProtocolPlayerTeamOneTableViewCell
